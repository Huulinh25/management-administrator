                ...
                <div class="card-body">
                    ...
                    <form action="{{route('profile')}}" enctype="multipart/form-data" class="form-horizontal form-material" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Johnathan Doe" name="name" class="form-control form-control-line" value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="example-email" class="col-md-12">Email</label>
                            <div class="col-md-12">
                                <input type="email" placeholder="johnathan@admin.com" disabled name="email" class="form-control form-control-line" value="" id="example-email">
                            </div>
                        </div>
                        <div class="form-group">

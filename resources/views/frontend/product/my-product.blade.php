                            ...
                            <table class="table-condensed small-table" style="width: 70%;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $product['price'] }}$</td>
                                        <td>
                                            <a href="{{ route('member.getEditProduct', ['id' => $product['id']]) }}"><i class="btn far fa-edit"></i></a>
                                            <a href="{{ route('member.deleteProduct', ['id' => $product['id']]) }}"><i class="btn far fa-trash-alt text-danger"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>

                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            @endphp
                                            <img src="{{ asset('member/user/upload/' . $avatarArray[0]) }}" alt="{{ $product['name'] }}">
                                            <h2>{{ $product['price'] }}$</h2>
                                            <p>{{ $product['name'] }}</p>
                                            <a href="{{route('member.detailProduct', ['id' => $product['id']])}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                        </div>

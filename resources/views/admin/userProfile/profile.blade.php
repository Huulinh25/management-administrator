                ...
                <div class="card-body">
                    ...
                    <form action="{{route('profile')}}" enctype="multipart/form-data" class="form-horizontal form-material" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Johnathan Doe" name="name" class="form-control form-control-line" value="{{ Auth::user()->name  }}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                ...
                                ?>
                                    ...
                                    <option value="{{ $country->id }}"{{ $country->id == Auth::user()->id_country ? 'selected' : '' }}
                                    >{{ $country->name }}</option> 
                                <?php
                                    } //end foreach
                                } // end if
